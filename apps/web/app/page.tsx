    ...
    <div className="workspace-shell">
      ...
      <aside className={`workspace-sidebar ${mobileNavOpen ? 'is-open' : ''}`}>
        ...
        <nav className="workspace-nav" aria-label="Workspace">
          ...
          <button type="button" className={`nav-item nav-icon-item ${workspaceView === 'wikipedia' ? 'active' : ''}`} onClick={() => { setWikipediaQuery(''); setWikipediaArticles([]); setWikipediaMessage(null); setWorkspaceView('wikipedia'); setMobileNavOpen(false) }}><Icon name="book" /> <span>Article</span></button>
